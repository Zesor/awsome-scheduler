  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        operatingSystem: "Web",
        description: "Modern React calendar and scheduler component provider for developers. Build scheduling, booking, and appointment systems with ease.",
        keywords: "React scheduler, React calendar, calendar component provider, scheduler component provider, React scheduling library",
        offers: [
          {
            "@type": "Offer",
            name: "Basic",
